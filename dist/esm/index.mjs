...
var translate = function (language) { return ({
    ...
    getTranslation: function (msgid, n, context, defaultPlural, languageKey, parameters, disableHtmlEscaping) {
        ...
        var pluginTranslationsNoSpaces = language.translationsNoSpaces;
        var translations = pluginTranslations[languageKey] || pluginTranslations[languageKey.split("_")[0]];
        var translationsNoSpaces = pluginTranslationsNoSpaces[languageKey] || pluginTranslationsNoSpaces[languageKey.split("_")[0]];
        if (!translations) {
            if (!silent) {
        ...
        if (!translated) {
            var msgIdNoSpaces = msgid.replace(/\s/g, "");
            var translatedNoSpaces = translationsNoSpaces[msgIdNoSpaces];
...
function createGettext(options) {
    ...
    var translationsNoSpaces = ref(normalizeTranslations(mergedOptions.translationsNoSpaces));
